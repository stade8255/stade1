...
///////////////////////////////////////////////////////////////////////////////
// 
// C:\Users\NINO\Desktop\TWINCAT ²ÕºA\13 axis\Task_RLeg.h

#define	TASK_RLEG_PORTNUMBER	301

#define	TASK_RLEG_INPUTSIZE	91
#define	TASK_RLEG_OUTPUTSIZE	91
...
typedef struct
{
	...
	long	RL_I_Vel_05;
	long	RL_I_Vel_06;
	unsigned short	RL_I_StatWord_13;
	long	RL_I_Enc_13;
	char	RL_I_Mode_13;
	short	RL_I_Torque13;
	long	RL_I_Vel_13;
...
typedef struct
{
	...
	unsigned short	RL_O_CtrlWord_13;
	long	RL_O_TarEnc_13;
	char	RL_O_SetMode_13;
	short	RL_O_TorqueOffset_13;
	long	RL_O_VelocityOffset_13;
