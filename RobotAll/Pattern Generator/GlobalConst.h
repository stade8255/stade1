...
//Save Data
#define WriteInitZMPtxt 1 // 將Initial時候的規劃好的ZMP 以及COG寫入txt file
...
#define PMSUpdate 1	//是否在給軌跡時開啟PMS畫圖 
...
#define cogestimate 1	// 開啟估測COG (FK_COG) = 1 

#define Push_recovery 1 //chehsuan
